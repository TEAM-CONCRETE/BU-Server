...
CREATE TABLE IF NOT EXISTS users (
    ...
    secret_key VARCHAR(100) COMMENT '비밀 키 (2FA 등)',
...
CREATE TABLE IF NOT EXISTS contract_details (
    ...
    work_time VARCHAR(100) COMMENT '근무 시간',
    break_time VARCHAR(100) COMMENT '휴게 시간',
    work_on_day VARCHAR(100) COMMENT '근무일',
    work_off_day VARCHAR(100) COMMENT '휴무일',
    work_pay DECIMAL(15,2) COMMENT '기본급',
    work_bonus DECIMAL(15,2) COMMENT '상여금',
    ...
    payday VARCHAR(30) COMMENT '급여 지급일',
